...
/***/ function(module, exports, __webpack_require__) {
	...
	var store = (0, _redux.createStore)(fn); //store
	
	var addCreator = function addCreator(text) {
	...
	var render = function render() {
	    return _reactDom2.default.render(_react2.default.createElement(App, { value: store.getState(),
	        add: function add() {
	            return store.dispatch(addCreator(1));
	        } }), root);
	};
